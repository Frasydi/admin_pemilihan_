...
export default function KandidatItem({ item }) {
    ...
    return (
        <>
            <Grid item xs={4}>
                <Card>
                    <CardMedia image={item?.gambar != null? "/api/gambar/"+item.gambar : "/blank.png"}
                    ...
                    <CardActions>
                        <Grid container spacing={2}>
                            <Grid item>
                                <button className="button-10" role="button" onClick={() => {
                            ...
                            <Grid item>
                                <button className="deletebtn" role="button" onClick={() => {
